...
class AbadehCrawler(University):
    ...
    def get_employees(self):
        with sync_playwright() as p:
            ...
            page.goto(
                "https://abadeh.iau.ir/fa/page/163/%D8%B4%D9%85%D8%A7%D8%B1%D9%87-%D8%AA%D9%85%D8%A7%D8%B3-%D9%87%D8%A7%DB%8C-%D9%88%D8%A7%D8%AD%D8%AF"
            )
        ...
        for row in rows:
            ...
            if len(columns) == 3:
                ...
                employee = Employee(
                    name=name, internal_number=id_number, phone_number=phone_number
                )
                yield employee
